...
private let logger = SamplesLogger.tagged("VideoChatRoomSDKManager")
...
class VideoChatSoraSDKManager {
  /// VideoChatSoraSDKManagerのシングルトンインスタンスです。
  static let shared = VideoChatSoraSDKManager()
