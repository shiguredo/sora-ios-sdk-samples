...
private let logger = SamplesLogger.tagged("ScreenCastSDKManager")
...
class ScreenCastSoraSDKManager {
  /// ScreenCastSoraSDKManagerのシングルトンインスタンスです。
  static let shared = ScreenCastSoraSDKManager()
  ...
  func connect(
    ...
    var configuration = Configuration(
      urlCandidates: ScreenCastEnvironment.urls,
      channelId: channelId,
      role: role)
    ...
    configuration.signalingConnectMetadata = ScreenCastEnvironment.signalingConnectMetadata
